...
class OnboardingRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateProfile(request: UpdateProfileRequestDto): CareerPilotResult<com.iti.careerpilot.core.network.model.UserResponseDto, NetworkError> = withContext(ioDispatcher) {
        try {
