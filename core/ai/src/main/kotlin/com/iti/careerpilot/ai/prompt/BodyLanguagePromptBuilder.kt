...
2. Gaze & Eye Contact (Weight: 30%):
   ...
   - Low eye contact (<40%): Flag as lack of focus, low confidence, or reading off-screen notes.
   - Continuous stare (>85%): Flag as overly intense or rigid camera focus.
3. Posture & Presence (Weight: 25%):
   - Engagement: Torso forward lean of +5° to +15° signals active engagement and attentiveness.
...
4. Hand Gestures & Kinesics (Weight: 25%):
   ...
   - Pacifying Behaviors (High Penalty): Hand-to-face touches (chin, nose, neck, hair) indicate anxiety and self-soothing under pressure.
   - Fidgeting: Repetitive finger tapping, pen clicking, or micro-movements (fidgetScore > 0.30) signal nervousness.
5. Facial Warmth & Dynamic Affect (Weight: 20%):
   - Dynamic smiling: Authentic smile peaks during greetings, positive achievements, and conclusions build strong rapport. Pleasant neutral while explaining technical logic.
6. Actionable Output:
