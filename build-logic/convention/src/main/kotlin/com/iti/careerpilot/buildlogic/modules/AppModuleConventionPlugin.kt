...
class AppModuleConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) = with(target) {
        ...
        add("implementation", "androidx-lifecycle-runtime-ktx")
        ...
        add("implementation", "androidx-core-splashscreen")
        add("implementation", "androidx-material3-android")
        add("implementation", "androidx-navigation3")
        add("implementation", "androidx-navigation3-ui")
        add("implementation", "androidx-lifecycle-viewmodel-navigation3")
        add("implementation", "animated-navigation-bar")
